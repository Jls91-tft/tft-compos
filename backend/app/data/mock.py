...
_META = {
    "tft": {
        "patch": "15.10", "rank": "Diamante +", "guide": True,
        ...
        "comps": [
            {"tier": "S", "name": "Flex Místicos", "style": "Standard", "difficulty": "Media",
             ...
             "units": [{"n": "Místico", "c": 4}, {"n": "Hechicero", "c": 3}, {"n": "Curandera", "c": 2}, {"n": "Centinela", "c": 1}]},
            {"tier": "S", "name": "Reroll Vanguardias", "style": "Reroll", "difficulty": "Fácil",
             "metrics": {"avg": "4.0", "top4": "62%", "win": "14%", "pick": "9.8%"},
             "units": [{"n": "Vanguardia", "c": 1}, {"n": "Berserker", "c": 2}, {"n": "Guardián", "c": 2}, {"n": "Herrero", "c": 3}]},
            {"tier": "S", "name": "Tempestad de Magos", "style": "Standard", "difficulty": "Media",
             "metrics": {"avg": "4.0", "top4": "61%", "win": "15%", "pick": "7.6%"},
             "units": [{"n": "Tempestad", "c": 5}, {"n": "Invocador", "c": 4}, {"n": "Vidente", "c": 3}, {"n": "Aprendiz", "c": 1}]},
            {"tier": "A", "name": "Fast 8 Francotiradores", "style": "Fast 8", "difficulty": "Difícil",
             "metrics": {"avg": "4.3", "top4": "55%", "win": "13%", "pick": "8.1%"},
             "units": [{"n": "Francotir.", "c": 4}, {"n": "Magista", "c": 5}, {"n": "Vidente", "c": 3}, {"n": "Tirador", "c": 2}]},
            {"tier": "A", "name": "Cazadores de élite", "style": "Standard", "difficulty": "Media",
             "metrics": {"avg": "4.4", "top4": "57%", "win": "11%", "pick": "6.9%"},
             "units": [{"n": "Cazador", "c": 4}, {"n": "Rastreador", "c": 2}, {"n": "Bestia", "c": 3}, {"n": "Montaraz", "c": 1}]},
            {"tier": "A", "name": "Reroll Berserkers", "style": "Reroll", "difficulty": "Fácil",
             "metrics": {"avg": "4.5", "top4": "54%", "win": "12%", "pick": "5.4%"},
             "units": [{"n": "Berserker", "c": 2}, {"n": "Bruto", "c": 1}, {"n": "Caudillo", "c": 4}, {"n": "Guardián", "c": 2}]},
            {"tier": "B", "name": "Forjados de hierro", "style": "Fast 8", "difficulty": "Difícil",
             "metrics": {"avg": "4.7", "top4": "50%", "win": "9%", "pick": "4.2%"},
             "units": [{"n": "Forjado", "c": 5}, {"n": "Coloso", "c": 4}, {"n": "Herrero", "c": 3}, {"n": "Recluta", "c": 1}]},
            {"tier": "B", "name": "Sombras asesinas", "style": "Standard", "difficulty": "Difícil",
             "metrics": {"avg": "4.8", "top4": "49%", "win": "10%", "pick": "3.8%"},
             "units": [{"n": "Sombra", "c": 4}, {"n": "Acechador", "c": 2}, {"n": "Espectro", "c": 3}, {"n": "Daga", "c": 1}]},
            {"tier": "C", "name": "Centinelas defensivos", "style": "Reroll", "difficulty": "Media",
             "metrics": {"avg": "5.3", "top4": "42%", "win": "6%", "pick": "2.1%"},
             "units": [{"n": "Centinela", "c": 1}, {"n": "Muro", "c": 2}, {"n": "Curandera", "c": 2}, {"n": "Guardián", "c": 2}]},
        ],
    },
    "lol": {
        "patch": "15.10", "rank": "Esmeralda +", "guide": False,
        ...
        "comps": [
            ...
            {"tier": "S", "name": "Asesino de jungla", "style": "Jungla", "difficulty": "Difícil",
             "metrics": {"win": "52%", "pick": "12%", "ban": "11%", "kda": "3.4"}, "units": []},
            {"tier": "A", "name": "Tirador de hipercarry", "style": "ADC", "difficulty": "Media",
             "metrics": {"win": "51%", "pick": "16%", "ban": "4%", "kda": "2.9"}, "units": []},
            {"tier": "A", "name": "Luchador de Top", "style": "Top", "difficulty": "Fácil",
             "metrics": {"win": "51%", "pick": "10%", "ban": "5%", "kda": "2.3"}, "units": []},
            {"tier": "A", "name": "Soporte de enganche", "style": "Support", "difficulty": "Media",
             "metrics": {"win": "50%", "pick": "9%", "ban": "6%", "kda": "2.6"}, "units": []},
            {"tier": "B", "name": "Tanque iniciador", "style": "Top", "difficulty": "Fácil",
             "metrics": {"win": "49%", "pick": "8%", "ban": "3%", "kda": "2.1"}, "units": []},
            {"tier": "B", "name": "Encantador protector", "style": "Support", "difficulty": "Media",
             "metrics": {"win": "49%", "pick": "11%", "ban": "2%", "kda": "3.0"}, "units": []},
            {"tier": "C", "name": "Asesino de carril medio", "style": "Mid", "difficulty": "Difícil",
             "metrics": {"win": "47%", "pick": "7%", "ban": "9%", "kda": "2.4"}, "units": []},
        ],
    },
}
