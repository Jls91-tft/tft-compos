/* Aevyn i18n — web bilingüe ES/EN sin framework.
 *
...
(function () {
  ...
  var DICT = {
    ...
    "Aevyn analiza cada partida que juegas, te dice exactamente qué falló, lo compara con quien ganó y te da un plan accionable para subir. Deja de adivinar por qué pierdes.":
      "Aevyn analyzes every game you play, tells you exactly what went wrong, compares it with the winner and gives you an actionable plan to climb. Stop guessing why you lose.",
    ...
    "Lo que hace Aevyn": "What Aevyn does",
    ...
    "Aevyn — Build de campeón": "Aevyn — Champion build",
    ...
    "Aevyn — Coaching IA y estadísticas para auto-battler y MOBA":
      "Aevyn — AI coaching and stats for auto-battler and MOBA",
    ...
    "Aevyn — Informe de coaching": "Aevyn — Coaching report",
    ...
    "Partida": "Game",
    "Análisis generado por Aevyn IA": "Analysis generated by Aevyn AI",
    ...
    "Aevyn — Guía de comp (datos de ejemplo)": "Aevyn — Comp guide (sample data)",
    ...
    "Aevyn — Lab (maqueta de rediseño · datos de ejemplo). Marca propia, no afiliada a los titulares de los juegos.":
      "Aevyn — Lab (redesign mockup · sample data). Own brand, not affiliated with the games' owners.",
    "Builds": "Builds",
  ...
  // API pública (para usar en JS: AevynI18N.t("texto"))
  window.AevynI18N = {
    apply: apply,
    setLang: setLang,
